...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
      {/* Navbar */}
      <nav className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-5 border-b border-white/10">
        ...
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-300 text-lg leading-8 max-w-xl mb-8">
              Book appointments with trusted doctors quickly and easily. Manage
              your appointments and get the healthcare you deserve.
            </p>
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative bg-slate-900/80 border border-blue-400/20 rounded-3xl p-8 shadow-2xl">
                <img
                  ...
                  className="w-full h-52 sm:h-64 object-cover rounded-2xl mb-6"
                />
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/80 rounded-xl p-4 flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold">Trusted Doctors</p>
      ...
      <section className="px-6 py-20 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto mb-12">
            MediCare makes it simple to find doctors, book appointments, and
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto mt-16">
            <div>
            ...
            <div>
              ...
              <p className="text-slate-400 mt-2">Specializations</p>
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-blue-400 font-semibold mb-3">OUR DOCTORS</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-blue-500/50 transition">
              <img
                src={doctorGeneral}
                alt="Dr. Arjun Mehta - General Physician"
                className="w-full h-auto object-contain rounded-xl mb-5"
              />
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-blue-500/50 transition">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Neurologist</h3>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-blue-400 font-semibold mb-3">OUR SERVICES</p>
